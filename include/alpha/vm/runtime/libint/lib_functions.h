...
void lib_objectmemberkeys(arch::cpu::Cpu& _cpu) noexcept(false);
void lib_objecttotalmembers(arch::cpu::Cpu& _cpu) noexcept(false);
void lib_objectcopy(arch::cpu::Cpu& _cpu) noexcept(false);
